...
OPTIMA = np.zeros([maxrep,nvar]) # array with best position found at each repetition
...
##########################################################################################
    ...
    OPTIMA[rep] = bestsol.position
    a = (np.around(OPTIMA[0:rep], decimals = digits) == np.around(bestsol.position, decimals = digits))
    b = np.all(a, axis = 1)
    n = np.count_nonzero(b)

    print("\n\n\n{}".format(OPTIMA[0:rep]))
    print("\n{}".format(bestsol.position))
    print("\n{}".format(a))
    print("\n{}".format(b))
    print("\n{}\n".format(n))
